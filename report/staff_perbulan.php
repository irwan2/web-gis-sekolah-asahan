...
<html>
    <head>
        <title>Cetak Data Staff Perbulan</title>
            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <h2>Sistem Informasi Geografis Sekolah Kabupaten Asahan </h2>
                        ...
                        <hr>
                        <h3>DATA STAFF BULAN   <? echo "$bulanNama $ambilthn"; ?></h3>
                ...
                <thead>
                            ...
                            $sql = "SELECT * FROM staff WHERE month(tgl_lahir)='$ambilbln' AND year(tgl_lahir)='$ambilthn'";
